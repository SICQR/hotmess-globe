  ...
  useEffect(() => {
    const fetchUser = async () => {
      try {
        ...
        logger.error('Failed to fetch user', { error: error?.message, context: 'Music' });
      }
    };
    fetchUser();
  }, []);
  ...
  const { data: musicEvents = [] } = useQuery({
    ...
    queryFn: async () => {
      try {
        ...
        logger.error('Failed to fetch music events', { error: error?.message, context: 'Music' });
        return [];
      }
    },
  ...
  const { data: releases = [] } = useQuery({
    ...
    queryFn: async () => {
      try {
        ...
        logger.error('Failed to fetch releases', { error: error?.message, context: 'Music' });
        return [];
      }
    }
  });
