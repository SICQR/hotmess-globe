      ...
      <div className="max-w-7xl mx-auto px-6 pb-32">
        ...
        >
          <div className="flex items-center gap-4 mb-8">
            <Phone className="w-8 h-8 text-[#E62020]" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {EMERGENCY_CONTACTS.map((contact, idx) => (
              <motion.a
                ...
                className="bg-white/5 border-2 border-white/10 hover:border-[#E62020] p-6 rounded-xl transition-all group"
              >
                <h3 className="font-black text-xl mb-2 group-hover:text-[#E62020] transition-colors">
                  {contact.name}
                </h3>
