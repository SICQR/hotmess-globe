  ...
  useEffect(() => {
    const fetchUser = async () => {
      try {
        ...
        logger.error('Failed to fetch user', { error: error?.message, context: 'RightNowDashboard' });
      }
    };
    fetchUser();
  }, []);
        ...
        >
          ...
          <div className="mb-8">
            <h1 className="text-4xl md:text-6xl font-black uppercase mb-2">
              RIGHT <span className="text-[#E62020]">NOW</span>
            </h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
            <div className="bg-white/5 border-2 border-white/10 p-6">
              <Zap className="w-8 h-8 text-[#E62020] mb-3" />
          ...
          {/* Tips */}
          <div className="mt-8 bg-[#E62020]/10 border-2 border-[#E62020]/40 p-6">
            <div className="flex items-start gap-3">
              <TrendingUp className="w-5 h-5 text-[#E62020] flex-shrink-0 mt-1" />
              <div>
