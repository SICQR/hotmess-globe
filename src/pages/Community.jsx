      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-3 gap-4 mb-8">
          <motion.div
            ...
            className="bg-gradient-to-br from-[#E62020]/20 to-[#B026FF]/20 border border-[#E62020]/40 rounded-xl p-4 text-center"
          >
            <Users className="w-6 h-6 text-[#E62020] mx-auto mb-2" />
        ...
        {posts.length >= 5 && (
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            className="mb-8 bg-gradient-to-br from-[#E62020]/20 to-[#FFEB3B]/20 border-2 border-[#E62020] p-6"
          >
        ...
        {user && !showCreatePost && (
          <Button
            ...
            className="w-full mb-6 bg-[#E62020] hover:bg-[#E62020]/90 text-black"
          >
