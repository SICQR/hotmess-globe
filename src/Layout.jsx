          ...
          <div className="md:hidden fixed top-0 left-0 right-0 z-50 bg-black/95 backdrop-blur-xl border-b border-white/10 pt-[env(safe-area-inset-top)]">
            <div className="flex items-center justify-between px-4 py-3">
              ...
              <div className="flex items-center gap-2">
                <Link
                  to={createPageUrl('RightNowDashboard')}
                  className="p-2 rounded-lg bg-[#E62020]/20 hover:bg-[#E62020]/30 transition-colors border border-[#E62020]/40"
                  aria-label="Go Live - Right Now"
                >
                  <Zap className="w-5 h-5 text-[#E62020]" />
                </Link>
                <Link
