  ...
  return (
    <div className="flex items-center gap-3">
      <div className="relative">
        <div className={`${sizes[size].avatar} rounded-full bg-gradient-to-br from-[#E62020] to-[#B026FF] flex items-center justify-center overflow-hidden`}>
          {user.avatar_url ? (
    ...
    >
      <div className="flex gap-1">
        {[0, 1, 2].map((i) => (
          <motion.span
            key={i}
            className="w-1.5 h-1.5 bg-[#E62020] rounded-full"
            animate={{ y: [0, -4, 0] }}
            transition={{
              duration: 0.6,
              repeat: Infinity,
