  ...
  return (
    ...
    >
      <motion.div
        ...
        className="bg-black border-2 border-[#C8962C] max-w-2xl w-full p-8 max-h-[90vh] overflow-y-auto"
      >
        <div className="text-center mb-8">
          <Shield className="w-16 h-16 mx-auto mb-4 text-[#C8962C]" />
        ...
        <div className="space-y-6 mb-8">
          <div className="bg-white/5 border-l-4 border-[#C8962C] p-4">
            <h3 className="font-black uppercase text-lg mb-3 text-[#C8962C]">
              OUR CONSENT CUE
            </h3>
        ...
        <div className="flex gap-3">
          ...
          <Button
            onClick={onAccept}
            disabled={!canProceed}
            className="flex-1 bg-[#C8962C] hover:bg-white text-black font-black uppercase py-4 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            AGREE & SEND
          </Button>
        </div>
