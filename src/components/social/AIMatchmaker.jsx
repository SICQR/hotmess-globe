    ...
    <div className="space-y-4">
      ...
      {loading && (
        <div className="text-center py-8">
          <div className="w-8 h-8 border-2 border-[#E62020] border-t-transparent rounded-full animate-spin mx-auto" />
        </div>
      )}
      ...
      <div className="space-y-3">
        {matches.map((match, idx) => (
          <motion.div
            ...
            className="bg-white/5 border border-[#E62020]/30 rounded-lg p-4"
          >
              ...
              <div className="flex items-center gap-3">
                <div 
                  ...
                  style={{
                    ...
                    borderColor: match.vibe?.vibe_color || '#E62020'
                  }}
                >
              ...
              <div 
                ...
                style={{
                  background: match.score >= 80 
                    ...
                    ? 'rgba(255, 20, 147, 0.3)'
                    : 'rgba(255, 20, 147, 0.2)',
                  border: `2px solid ${match.score >= 80 ? '#E62020' : 'rgba(255, 20, 147, 0.3)'}`
                }}
              >
            ...
            <div className="space-y-1 mb-3">
              {match.reasons.map((reason, i) => (
                <div key={i} className="flex items-center gap-2 text-xs text-[#E62020]">
            ...
            <div className="flex gap-2">
              <Link to={createPageUrl(`Profile?email=${match.user.email}`)} className="flex-1">
                <Button variant="outline" className="w-full border-[#E62020] text-[#E62020] hover:bg-[#E62020]/10 font-black rounded-lg">
                  PROFILE
                </Button>
              </Link>
              <Link to={`/social/inbox?to=${encodeURIComponent(String(match?.user?.email || ''))}`} className="flex-1">
                <Button className="w-full bg-[#E62020] hover:bg-[#E62020]/90 text-black font-black rounded-lg">
                  MESSAGE
                </Button>
              </Link>
            </div>
