      ...
      <AnimatePresence>
        {!isOpen && (
          <motion.button
            ...
            className="fixed bottom-6 right-6 z-50 w-14 h-14 bg-gradient-to-br from-[#E62020] to-[#B026FF] rounded-full flex items-center justify-center border-2 border-white shadow-[0_0_20px_rgba(255,20,147,0.5)] hover:shadow-[0_0_30px_rgba(255,20,147,0.8)] transition-all"
          >
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed bottom-6 right-6 w-full md:w-[420px] h-[600px] bg-black border-2 border-[#E62020] z-50 flex flex-col shadow-[0_0_40px_rgba(255,20,147,0.3)]"
          >
            {/* Header */}
            <div className="bg-gradient-to-r from-[#E62020] to-[#B026FF] border-b-2 border-white p-4">
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-4 bg-black">
              {messages.length === 0 ? (
                <div className="text-center py-8">
                  <Sparkles className="w-12 h-12 mx-auto mb-4 text-[#E62020]" />
                  ...
                  <div className="space-y-2">
                    ...
                    {quickQuestions.map((q, idx) => (
                      <button
                        key={idx}
                        onClick={() => setInput(q)}
                        className="block w-full text-left px-3 py-2 bg-white/5 border border-white/10 hover:border-[#E62020] text-xs text-white/80 transition-all"
                      >
                        {q}
                      </button>
                    ))}
                    ...
                    <div className={`max-w-[80%] ${msg.role === 'user' ? 'order-first' : ''}`}>
                      <div
                        className={`px-4 py-2.5 text-sm ${
                          msg.role === 'user'
                            ? 'bg-[#E62020] text-white border-2 border-white'
            ...
            {/* Input */}
            <div className="border-t-2 border-[#E62020] p-4 bg-black">
