          ...
          {!showSettings ? (
            ...
            <div className="p-4 md:p-6">
              <div className="flex items-start gap-4">
                <Cookie className="w-8 h-8 text-[#C8962C] shrink-0 mt-1" />
                <div className="flex-1">
                  ...
                  <p className="text-sm text-white/70 mb-4">
                    ...
                    Read our{' '}
                    <Link to={createPageUrl('PrivacyPolicy')} className="text-[#C8962C] hover:underline">
                      Privacy Policy
                    </Link>{' '}
                  ...
                  <div className="flex flex-wrap gap-3">
                    <button
                      onClick={acceptAll}
                      className="px-6 py-2 bg-[#C8962C] hover:bg-[#C8962C]/80 font-bold uppercase text-sm transition-colors"
                    >
                      Accept All
                    </button>
                    <button
            ...
            <div className="p-4 md:p-6">
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-3">
                  <Cookie className="w-6 h-6 text-[#C8962C]" />
                      ...
                      {category.required ? (
                        ...
                        <button
                          ...
                          className={`w-12 h-6 rounded-full transition-colors relative ${
                            preferences[category.id] ? 'bg-[#C8962C]' : 'bg-white/20'
                          }`}
                        >
                          <span
              ...
              <div className="flex flex-wrap gap-3">
                <button
                  ...
                  className="px-6 py-2 bg-[#C8962C] hover:bg-[#C8962C]/80 font-bold uppercase text-sm transition-colors flex items-center gap-2"
                >
