    ...
    <div className="pb-20 -mt-4">
      ...
      {v6GhostedLoop && (
        <MutualStateOverlay
          ...
          // HOTFIX 2026-06-03 — delay handleMessage by 260ms so the overlay
          // exit animation finishes before the chat sheet mounts. Prior to
          // this the overlay's MESSAGE CTA stacked on top of the profile's
          // own MESSAGE button mid-fade (Phil live repro).
          onMessage={() => {
            setShowMutual(false);
            setTimeout(() => handleMessage(), 260);
          }}
