...
export default function RightNowIndicator({ status, compact = false }) {
  ...
  if (compact) {
    return (
      <div className="inline-flex items-center gap-1 px-2 py-1 bg-[#E62020] text-black text-xs font-black uppercase border-2 border-white animate-pulse">
  ...
  return (
    <div className="bg-gradient-to-r from-[#E62020]/20 to-[#E62020]/10 border-2 border-[#E62020] p-4 space-y-3">
      {/* Header */}
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          <div className="w-3 h-3 bg-[#E62020] rounded-full animate-pulse" />
          <span className="text-xs font-black uppercase text-[#E62020]">RIGHT NOW</span>
        </div>
        ...
        <div className="flex flex-wrap gap-2">
          {status.logistics.map(log => {
            ...
            return (
              <div
                key={log}
                className="flex items-center gap-1 px-2 py-1 bg-black/40 border border-[#E62020]/40 text-[#E62020] text-xs font-bold uppercase"
              >
