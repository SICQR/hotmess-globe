...
const SIGNAL_STYLES = {
  now_nearby: { label: 'Now nearby', bg: 'bg-gradient-to-r from-[#00C2E0] to-[#00C2E0]/80', text: 'text-black', icon: '📍' },
  active_tonight: { label: 'Active tonight', bg: 'bg-gradient-to-r from-[#C8962C] to-[#C8962C]/80', text: 'text-white', icon: '🌙' },
  looking_right_now: { label: 'Looking now', bg: 'bg-gradient-to-r from-[#C8962C] to-[#00C2E0]', text: 'text-white', icon: '👀', pulse: true },
  ...
  followed_active: { label: 'Following • Active', bg: 'bg-[#00C2E0]/90', text: 'text-black', icon: '💫' },
