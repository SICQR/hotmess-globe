...
export default function EventTicket({ rsvp, event }) {
  ...
  return (
    <motion.div
      ...
      className="bg-gradient-to-br from-[#E62020]/10 to-[#00D9FF]/10 border-2 border-[#E62020] p-6 space-y-4"
    >
      <div className="flex items-center gap-2 mb-4">
        <Ticket className="w-6 h-6 text-[#E62020]" />
      ...
      <div className="border-t-2 border-white/20 pt-4">
        <Button
          ...
          className="w-full bg-[#E62020] hover:bg-white text-black font-black mb-2"
        >
