      ...
      <div className="space-y-4">
        {relatedEvents.map((event, idx) => (
          ...
          >
            ...
            >
              <div className="bg-black border-2 border-white/20 hover:border-[#C8962C] transition-all p-4">
                {event.image_url && (
                ...
                <h4 className="font-black uppercase tracking-tight mb-2 group-hover:text-[#C8962C] transition-colors">
                  {event.title}
                </h4>
