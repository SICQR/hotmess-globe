          ...
          return (
            <motion.div
              ...
              className={`bg-gradient-to-br ${
                isHighMatch 
                  ? 'from-[#B026FF]/20 to-[#E62020]/20 border-2 border-[#B026FF]' 
                  : 'from-white/5 to-white/5 border border-white/10'
              } rounded-xl p-4 relative overflow-hidden`}
            >
              {isHighMatch && (
                <motion.div
                  className="absolute top-2 right-2 bg-gradient-to-r from-[#E62020] to-[#B026FF] px-3 py-1 rounded-full text-xs font-black flex items-center gap-1"
              ...
              <div className="mb-3">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span 
                    ...
                    style={{ 
                      color: rec.score >= 80 ? '#B026FF' : rec.score >= 60 ? '#E62020' : '#00D9FF' 
                    }}
                  >
                    {rec.score}%
                  </span>
                ...
                <div className="h-1.5 bg-white/10 rounded-full overflow-hidden">
                  <motion.div
                    className="h-full bg-gradient-to-r from-[#B026FF] to-[#E62020]"
                    initial={{ width: 0 }}
              ...
              <Link to={`/events/${encodeURIComponent(event.id)}`}>
                <Button 
                  className={`w-full ${
                    isHighMatch 
                      ? 'bg-gradient-to-r from-[#B026FF] to-[#E62020] hover:opacity-90' 
