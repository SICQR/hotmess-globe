...
// Phil 2026-05-31 hotfix-3: prefixes are MATCHED CASE-INSENSITIVELY in
// isPublicRoute below. Keep entries here lowercase. The previous case-
// sensitive match meant /Contact (capital C) and /CommunityGuidelines etc.
// rendered briefly via the AuthenticatedApp route, then BootRouter re-ran
// after auth-state resolution and bounced them through OnboardingRouter.
const PUBLIC_PATH_PREFIXES = [
  ...
  '/privacy',
  '/guidelines',
  '/communityguidelines', // Settings → Community Guidelines link
  '/contact',
  '/help',
  '/helpcenter',          // Settings → Help Center link
  '/accessibility',
...
export default function BootRouter({ children }) {
  ...
  // Phil 2026-05-31 hotfix-3: lowercase the path so /Contact matches
  // /contact, /CommunityGuidelines matches /communityguidelines, etc.
  // Without this, Settings links generated by createPageUrl('PageName')
  // bounced through OnboardingRouter.
