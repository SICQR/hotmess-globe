    ...
    <div className="min-h-screen bg-black text-white flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="text-center mb-12">
          <motion.div
            className="w-20 h-20 bg-gradient-to-br from-[#B026FF] to-[#E62020] mx-auto mb-6 flex items-center justify-center"
            animate={{
              boxShadow: [
        ...
        <div className="flex gap-4">
          ...
          <Button
            ...
            className="flex-1 bg-gradient-to-r from-[#B026FF] to-[#E62020] hover:opacity-90 text-white font-black"
          >
            {analyzing ? (
              <>
