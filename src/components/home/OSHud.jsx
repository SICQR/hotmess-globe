...
export default function OSHud({ user, onModuleChange }) {
  ...
  return (
    <>
      {/* Top HUD */}
      <div className="fixed top-0 left-0 right-0 z-40 bg-black/80 backdrop-blur-xl border-b border-[#E62020]/30">
        <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
          <div className="flex items-center gap-4">
            <div className="text-xl font-black tracking-tighter text-white">
              HOTMESS<span className="text-[#E62020]">OS</span>
            </div>
          </div>
            ...
            <div className="flex items-center gap-4">
              <div className="text-right">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm font-black text-[#E62020] font-mono">{user.xp || 0} XP</span>
                  <span className="text-xs text-white/60">• LVL {level}</span>
                </div>
              </div>
              <div className="w-32 h-1 bg-white/10 rounded-full overflow-hidden">
                <div 
                  className="h-full bg-gradient-to-r from-[#E62020] to-[#FFEB3B] transition-all duration-300"
      ...
      <div className="fixed bottom-0 left-0 right-0 z-40 bg-black/90 backdrop-blur-xl border-t-2 border-[#E62020]">
