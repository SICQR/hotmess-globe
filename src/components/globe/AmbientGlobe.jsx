...
/**
 * Render an animated, decorative ambient globe as a non-interactive React element.
 *
 * The component produces a full-size, absolutely positioned canvas with subtle motion trails,
 * drifting particles, city heat glows, faint grid lines, and delicate connections, plus two
 * gradient overlays for readability. It is purely visual (pointer-events disabled) and manages
 * its own retina-scaled canvas sizing and animation loop.
 *
 * @returns {JSX.Element} A non-interactive container with a canvas element and vignette overlays. 
 */
