    ...
    <div className="h-full flex flex-col">
      <div className="p-4 border-b-2 border-white/20">
        <button
          ...
          className={`w-full bg-[#E62020] hover:bg-white text-black hover:text-black font-black uppercase text-sm py-3 border-2 border-white transition-all ${
      ...
      <div className="flex-1 overflow-y-auto space-y-2 p-2">
        ...
        const color = THREAD_TYPE_COLORS[thread.thread_type] || '#E62020';
        ...
        return (
          <motion.button
            ...
            className={`w-full bg-black hover:bg-white/5 border-2 p-4 transition-all text-left ${
              unreadCount > 0 ? 'border-[#E62020]' : 'border-white/20 hover:border-white/40'
            }`}
          >
            <div className="flex items-start gap-3">
              {!isGroupChat && otherUsers[0] ? (
                <div className="w-12 h-12 bg-gradient-to-br from-[#E62020] to-[#B026FF] flex items-center justify-center flex-shrink-0 border-2 border-white">
              ...
              {unreadCount > 0 && (
                <Badge className="bg-[#E62020] text-black flex-shrink-0 font-black border-2 border-white">
                  {unreadCount}
                </Badge>
              )}
            </div>
