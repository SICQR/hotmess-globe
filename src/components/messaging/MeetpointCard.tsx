...
/**
 * Renders an inline meetpoint card with a dark satellite-style map, ETA countdown, transport estimates, and actions for routing, booking, and live sharing.
 *
 * @param title - The meetpoint title shown prominently.
 * @param address - Optional human-readable address displayed beneath the title.
 * @param lat - Destination latitude used for the map tile and external links.
 * @param lng - Destination longitude used for the map tile and external links.
 * @param distanceM - Optional distance to the destination in meters; formatted as meters or kilometers for display.
 * @param etaMin - Estimated arrival time in minutes; initializes the countdown and derives walking/driving/transit estimates.
 * @param retracted - When true, shows a "Meetpoint pulled" badge indicating the meetpoint is no longer active.
 * @returns The rendered React element for the meetpoint card.
 */
