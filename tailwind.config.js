  ...
  theme: {
  	extend: {
  		...
  		colors: {
  			...
  			// Royal Blue - From HOTMESS hoodie
  			blue: {
  				DEFAULT: '#0047AB',
  				50: '#E5F0FF',
  				100: '#CCE0FF',
  		...
  		boxShadow: {
  			...
  			'glow-blue-lg': '0 0 40px rgba(0, 71, 171, 0.6)',
