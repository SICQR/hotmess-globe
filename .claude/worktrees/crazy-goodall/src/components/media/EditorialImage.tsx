...
export function EditorialImage({
  ...
  // LED Brutalist overlays - hot pink #C8962C, cyan #00C2E0
  const overlayColors = {
    hot: 'bg-gradient-to-br from-[#C8962C]/40 via-[#C8962C]/20 to-transparent',
    cyan: 'bg-gradient-to-br from-[#00C2E0]/30 via-[#00C2E0]/15 to-transparent',
    dual: 'bg-gradient-to-br from-[#C8962C]/30 via-[#00C2E0]/20 to-[#C8962C]/10',
    none: '',
  };
