      ...
      {displayFriends.length > 0 && (
        <div className="flex -space-x-2">
          {displayFriends.map((friend, idx) => (
            <div
              key={idx}
              className="w-6 h-6 rounded-full border-2 border-black bg-gradient-to-br from-[#C8962C] to-[#C8962C] flex items-center justify-center text-xs font-bold overflow-hidden"
            >
              {friend.avatar_url ? (
